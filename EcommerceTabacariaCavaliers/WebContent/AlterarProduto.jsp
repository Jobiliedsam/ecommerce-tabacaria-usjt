						...
						<div class="col">
							...
							<div id="main" class="container">
								...
								<form action="controller.do" method="post">
									...
									<div class="row">
									   <div class="col-md-12">
											   <label for="precoF">Pre�o Produto</label>
											   <input type="text" name="precoF" class="form-control" id="precoF" required maxlength="10" placeholder="Pre�o do Produto" value="${produto.precoF }" >
										   </div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" name="descricao" class="form-control" id="descricao" required maxlength="100" placeholder="Descri�ao" value="${produto.descricao }">
								</div>
							</div>
									<hr />
