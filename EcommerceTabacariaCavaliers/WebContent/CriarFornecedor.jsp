                                ...
                                <form action="controller.do" method="post">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="tel" class="form-control" name="contatoTelefone"
                                                id="contatoTelefone" maxlength="12">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="contatoEmail">E-Mail</label>
                                            <input type="email" class="form-control" name="contatoEmail"
                                                id="contatoEmail" required maxlength="60"
                                                placeholder="email obrigatï¿½rio">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-12">
