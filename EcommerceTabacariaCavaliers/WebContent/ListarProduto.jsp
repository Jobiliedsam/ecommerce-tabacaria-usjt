                            ...
                            <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> Deseja excluir este produto? </div>
                            ...
                            <div id="main" class="container">
                                <form action="controller.do" method="post">
                                    <div id="top" class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="CriarProduto.jsp" class="btn btn-primary pull-right h2">Novo
                                                Produto</a>
                                        </div>
                                    </div>
                                    <!-- /#top -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="actions">
                                                                <a class="btn btn-success btn-xs"
                                                                    href="controller.do?command=VisualizarProduto&id=${produto.idProduto}">Visualizar</a>
