                            ...
                            <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> Deseja excluir este fornecedor? </div>
                            ...
                            <div id="main" class="container">
                                <form action="controller.do" method="post">
                                    <div id="top" class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="CriarFornecedor.jsp" class="btn btn-primary pull-right h2">Novo
                                                Fornecedor</a>
                                        </div>
                                    </div>
                                    <!-- /#top -->
                                                ...
                                                <tbody>
                                                    <c:forEach var="fornecedor" items="${listaFornecedor }">
                                                        <tr>
                                                            ...
                                                            <td> ${fornecedor.contatoTelefone } </td>
                                                            <td> ${fornecedor.contatoEmail } </td>
                                                            <td> ${fornecedor.descricao } </td>
                                                            <td class="actions">
                                                                <a class="btn btn-success btn-xs"
                                                                    href="controller.do?command=VisualizarFornecedor&id=${fornecedor.idFornecedor}">Visualizar</a>
                                                                <a class="btn btn-warning btn-xs"
                                                                    href="controller.do?command=EditarFornecedor&idFornecedor=${fornecedor.idFornecedor}">Editar</a>
                                                                <a class="btn btn-danger btn-xs"
                                                                    href="controller.do?command=ExcluirFornecedor&id=${fornecedor.idFornecedor}">Excluir</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
