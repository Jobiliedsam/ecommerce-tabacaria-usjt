								...
								<div class="row">
									<div class="form-group col-md-12">
										<label for="nomeP">Nome do Produto:</label> <input type="text"
											class="form-control" name="nomeP" id="nomeP" required
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label for="categoria">Categoria:</label> <input type="text"
											...
											maxlength="15" placeholder="Categoria ">
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-12">
										<label for="fornecedor">Fornecedor</label> <input type="text"
											class="form-control" name="fornecedor" id="fornecedor"
											required maxlength="60" placeholder="Fornecedor">
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-12">
										<label for="status">Status</label> <input type="text"
											...
											maxlength="60" placeholder="Status">
									</div>
								</div>
						<div class="row">
							<div class="form-group col-md-12">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label for="quantidade"> Quantidade: </label> <input
									...
									id="quantidade" required maxlength="100"
