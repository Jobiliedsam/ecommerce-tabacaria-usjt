                            ...
                            <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> Deseja excluir este Usuario? </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="actions">
                                                                <a class="btn btn-success btn-xs"
                                                                    href="controller.do?command=VisualizarUsuario&id=${usuario.id }">Visualizar</a>
                                                                <a class="btn btn-warning btn-xs"
                                                                    href="controller.do?command=EditarUsuario&id=${usuario.id}">Editar</a>
                                                                <a href="controller.do?command=ExcluirUsuario&id=${usuario.id }"
