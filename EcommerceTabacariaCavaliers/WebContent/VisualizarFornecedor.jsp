						...
						<div class="col">
							...
							<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">Deseja realmente excluir este fornecedor?</div>
							...
							<div id="main" class="container">
								...
								<div id="actions" class="row">
									<div class="col-md-12">
										<a href="controller.do?command=EditarFornecedor&id=${fornecedor.idFornecedor }"
											class="btn btn-primary">Editar</a> <a href="#" class="btn btn-danger"
											data-toggle="modal" data-target="#delete-modal">Excluir</a> <a
