                            ...
                            <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> Deseja excluir esta categoria? </div>
                                        <div class="modal-footer">
                                            <form action="controller.do" method="post">
                                                <input type="hidden" name="id" id="id_excluir" />
                                                <button type="submit" class="btn btn-primary" name="command"
                                                    value="ExcluirCategoria">Sim</button>
                            ...
                            <div id="main" class="container">
                                <form action="controller.do" method="post">
                                    <div id="top" class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="CategoriaIndex.jsp" class="btn btn-primary pull-right h2">Nova
                                                Categoria</a>
                                        </div>
                                    </div>
                                    <!-- /#top -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="actions">
                                                                <a class="btn btn-success btn-xs"
                                                                    href="controller.do?command=VisualizarCategoria&id=${categoria.idCategoria}">Visualizar</a>
                                                                <a class="btn btn-warning btn-xs"
                                                                    href="controller.do?command=EditarCategoria&id=${categoria.idCategoria}">Editar</a>
                                                                <a class="btn btn-danger btn-xs"
                                                                    href="controller.do?command=ExcluirCategoria&id=${categoria.idCategoria}">Excluir</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
